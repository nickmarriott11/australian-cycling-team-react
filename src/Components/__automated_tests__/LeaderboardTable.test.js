...
// Test to verify that the LeaderboardTable renders all necessary table elements
...
// Test to verify that the LeaderboardTableRow renders with the correct values
